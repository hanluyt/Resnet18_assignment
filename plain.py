...
# Plain18
model = PlainNet(ResidualBlock, [2, 2, 2, 2])
# Plain34
# model = PlainNet(ResidualBlock, [3, 4, 6, 3])
...
# save result
np.save('plain18_acc.npy', accuracy_stats)
np.save('plain18_loss.npy', loss_stats)
...
plt.savefig('plain18_result.png', dpi=300)
